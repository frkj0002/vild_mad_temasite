...
// Sæson variabler
let spring = document.querySelector("#firstQuestion .answerBox:nth-child(1)");
let summer = document.querySelector("#firstQuestion .answerBox:nth-child(2)");
let fall = document.querySelector("#firstQuestion .answerBox:nth-child(3)");
let winter = document.querySelector("#firstQuestion .answerBox:nth-child(4)");
...
// Landskab variabler
let beach = document.querySelector("#secondQuestion .answerBox:nth-child(1)");
let forest = document.querySelector("#secondQuestion .answerBox:nth-child(2)");
let city = document.querySelector("#secondQuestion .answerBox:nth-child(3)");
let fields = document.querySelector("#secondQuestion .answerBox:nth-child(4)");
...
// Farve variabler
let white = document.querySelector("#thirdQuestion .answerBox:nth-child(1)");
let yellow = document.querySelector("#thirdQuestion .answerBox:nth-child(2)");
let green = document.querySelector("#thirdQuestion .answerBox:nth-child(3)");
let purple = document.querySelector("#thirdQuestion .answerBox:nth-child(4)");
